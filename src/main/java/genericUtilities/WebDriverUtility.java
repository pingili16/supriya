...
public class WebDriverUtility {
    ...
    /**
     * This method waits element is displayed on the web page
     * @param time
     * @param element
     * @return
     */
    ...
    */
    ...
    /**
     * This method is used to mouse have on an element
     * @param element
     */
  ...
  /**
   * This mathod is used to switch to frame based on frame element
   * @param frameElement
   */
    ...
    /** 
     * This mathod is used to switch back to the default web page
     */
  ...
  /**
   * This method is used to scoll till the spectified element on the web page
   * @param element
   */
  ...
  /** 
   * This method is used to halde alert pop up
   * @param status
   */
   ...
   */
   public void switchToChildBrowser() {
	...
	for(String window : windowIDs) {
     ...
     /**
      * This method is used is used to switch to spectified window
      * @return
      */
    ...
    * @return
    */
   public WebElement convertPathToWebElement(String path,String replacedData) {
	   String requiredPath = String.format(path,replacedData);
